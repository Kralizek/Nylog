...
namespace Tests
{
    ...
    public class LoggerTests
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new Logger(null, logName));
        }

        [Test]
        public void Name_is_required()
        {
            Assert.Throws<ArgumentNullException>(() => new Logger(Mock.Of<ILoggerFactory>(), null));
        }
        ...
        public void Log_throws_if_an_inner_logger_throws()
        {
            ...
            Assert.Throws<AggregateException>(() => sut.Log(level, state, error));
        }
        ...
        public void IsEnabled_groups_exceptions(LogLevel level)
        {
            ...
            Assert.Throws<AggregateException>(() => sut.IsEnabled(level));
        }
